...
router.post('/', asyncHandler(async (req, res) => {
    try {
        uploadCategory.single('img')(req, res, async function (err) {
            ...
            let imageUrl = 'no_url';
            if (req.file) {
                imageUrl = `https://classy-bubblegum-0e4d00.netlify.app/image/category/${req.file.filename}`;
            }
...
router.put('/:id', asyncHandler(async (req, res) => {
    try {
        ...
        uploadCategory.single('img')(req, res, async function (err) {
            ...
            if (req.file) {
                image = `https://classy-bubblegum-0e4d00.netlify.app/image/category/${req.file.filename}`;
            }
